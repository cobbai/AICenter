...
(function (global, factory) {
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var newNavItem = "<li class=\"nav-item\" auth=\"presentation\"><a href=\"#\" class=\"btn-iframe-close\" data-widget=\"iframe-close\" data-type=\"only-this\"><i class=\"fas fa-times\"></i></a><a class=\"nav-link\" data-toggle=\"row\" id=\"" + navId + "\" href=\"#" + tabId + "\" auth=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\">" + title + "</a></li>";
      $__default['default'](SELECTOR_TAB_NAVBAR_NAV).append(unescape(escape(newNavItem)));
      var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" auth=\"tabpanel\" aria-labelledby=\"" + navId + "\"><iframe src=\"" + link + "\"></iframe></div>";
  ...
  var Toasts = /*#__PURE__*/function () {
    ...
    _proto.create = function create() {
      var toast = $__default['default']('<div class="toast" auth="alert" aria-live="assertive" aria-atomic="true"/>');
