...
(function(mod) {
  ...
  CodeMirror.defineMode("soy", function(config) {
    ...
    function ref(list, name, loose) {
      return contains(list, name) ? "variable-2" : (loose ? "variable" : "variable-2 temp");
    }
    ...
    return {
      startState: function() {
        return {
          ...
          quoteKind: null,
          context: null,
          lookupVariables: true, // Is unknown variables considered an temp
          localStates: [{
            mode: modes.html,
